...
namespace Krkadoni.EnigmaSettings
{
    ...
    public class TransponderDVBS : Transponder, ITransponderDVBS
    {
        ...
        public new object Clone()
        {
            ...
            transponder.Satellite = (IXmlSatellite)Satellite?.Clone();
            return transponder;
        }
        #endregion
        ...
        /// <summary>
        ///     Initializes new satellite transponder from data found in services file
        /// </summary>
        ...
        public IXmlSatellite Satellite
        {
            ...
            set
            {
                ...
                _satellite = value;
                OnPropertyChanged(nameof(Satellite));
            }
        }
        ...
        public string Polarization
        {
            ...
            set
            {
                ...
                if (value == _polarization) 
                    return;

                _polarization = value;
                OnPropertyChanged(nameof(Polarization));
                OnPropertyChanged(nameof(PolarizationType));
            }
        }
        ...
        {
            get => _orbitalPositionInt;
            set
            {
                if (value == _orbitalPositionInt) 
                    return;

                _orbitalPositionInt = value;
                OnPropertyChanged(nameof(OrbitalPositionInt));
                OnPropertyChanged(nameof(OrbitalPositionHex));
            }
        }
        ...
        {
            get => _orbitalPositionInt.ToString("X");
            set
            {
                ...
                try
                {
                    OrbitalPositionInt = int.Parse(value, NumberStyles.HexNumber);
                }
                catch (Exception)
                {
        ...
        public string RollOff
        {
            ...
            set
            {
                ...
                OnPropertyChanged(nameof(RollOffType));
            }
        }
        ...
        public string Pilot
        {
            ...
            set
            {
                ...
                OnPropertyChanged(nameof(PilotType));
            }
        }
        ...
        public string PlsCode
        {
            ...
            set
            {
                ...
                _pls_code = value;
                OnPropertyChanged(nameof(PlsCode));
            }
        }
        ...
        public string PlsMode
        {
            ...
            set
            {
                ...
                _pls_mode = value;
                OnPropertyChanged(nameof(PlsMode));
            }
        }
        ...
        public string T2miPlpId
        {
            ...
            set
            {
                if (value == _t2mi_plp_id) 
                    return;

                _t2mi_plp_id = value;
                OnPropertyChanged(nameof(T2miPlpId));
            }
        }
        ...
        public string T2miPid
        {
            ...
            set
            {
                ...
                _t2mi_pid = value;
                OnPropertyChanged(nameof(T2miPid));
            }
        }
        ...
        {
            string tType = string.Join("", "\t", "s", " ", Frequency);

            if (SystemType == Enums.DVBSSystemType.DVBS & ModulationType == Enums.DVBSModulationType.Auto)
                return string.Join("\t", string.Join(":", NameSpc.PadRight(8, '0'), TSID.PadLeft(4, '0'), NID.PadLeft(4, '0')), string.Join(":", tType, SymbolRate.PadRight(8, '0'), Polarization, FEC, OrbitalPositionInt.ToString(CultureInfo.CurrentCulture), Inversion, Flags), "/" ).TrimEnd(':');
            
            if (SystemType == Enums.DVBSSystemType.DVBS)
                return string.Join("\t", string.Join(":", NameSpc.PadRight(8, '0'), TSID.PadLeft(4, '0'), NID.PadLeft(4, '0')), string.Join(":", tType, SymbolRate.PadRight(8, '0'), Polarization, FEC, OrbitalPositionInt.ToString(CultureInfo.CurrentCulture), Inversion, Flags, System, Modulation), "/").TrimEnd(':');

            return string.Join("\t", string.Join(":", NameSpc.PadRight(8, '0'), TSID.PadLeft(4, '0'), NID.PadLeft(4, '0')), string.Join(":", tType, SymbolRate.PadRight(8, '0'), Polarization, FEC, OrbitalPositionInt.ToString(CultureInfo.CurrentCulture), Inversion, Flags, System, Modulation, RollOff, Pilot, IsId, PlsCode, PlsMode, T2miPlpId, T2miPid), "/").TrimEnd(':');
        }
    }
}