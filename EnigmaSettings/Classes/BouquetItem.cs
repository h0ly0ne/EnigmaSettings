...
namespace Krkadoni.EnigmaSettings
{
    ...
    public abstract class BouquetItem : IBouquetItem
    {
        ...
        {
            get => _favoritesTypeFlag;
            set
            {
                if (value == null)
                    return;

                if (value == _favoritesTypeFlag)
                    return;

                _favoritesTypeFlag = value;
                OnPropertyChanged(nameof(FavoritesTypeFlag));
                OnPropertyChanged(nameof(FavoritesType));
            }
        }
        ...
        {
            get => _lineSpecifierFlag;
            set
            {
                if (value == null)
                    return;

                if (value == _lineSpecifierFlag)
                    return;

                _lineSpecifierFlag = value;
                OnPropertyChanged(nameof(LineSpecifierFlag));
                OnPropertyChanged(nameof(LineSpecifierType));
            }
        }
